...
(2, 'Sérotonine','Michel Houellebecq', 'fiction', 'français', 'Flammarion', 'Le narrateur de Sérotonine approuverait sans réserve. Son récit traverse une France qui piétine ses traditions, détruit ses campagnes au bord de la révolte. ', '04/01/2019'),
(3, 'Tous les hommes n’habitent pas le monde de la même façon', 'Jean-Paul Dubois', 'roman', 'français', 'éditions de lOlivier', 'Le prix Goncourt 2019 retrace la vie de Paul Hansen qui déploie ses talents de concierge, de gardien et de réparateur des âmes.', '14/08/2019'),
